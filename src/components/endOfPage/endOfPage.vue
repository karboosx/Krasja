  ...
  <div class="footer">
    <div class="footer_media">
      ...
      <div class="footer_media_icons">
        ...
        <span class="footer_media_icons_social_media footer_media_icons_social_media--pinteres">youtube</span>
      </div>
    </div>

    <div class="footer_icon">
      <img class="footer_icon_img" src="../../assets/icons/sword_footer.png">
    </div>
